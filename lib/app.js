...
var init = exports.init = function (config) {
  ...
  app.use('/tests', auth.requireUser, require('./routes/tests'));
...
var run = exports.run = function (app) {
  ...
  // Initialize Robot
  // Robot.run(common.emitter)

  console.info('Express server listening on %s:%d in %s mode', config.host, config.port, app.settings.env);
};
